...
def add_guess():
    try:
        ...
        print("ERROR in add_guess:", e, flush=True)
...
def get_guesses():
    try:
        ...
        print("ERROR in get_guesses:", e, flush=True)
        return jsonify({"error": str(e)}), 500
...
def reset():
    try:
        ...
        print("ERROR in reset:", e, flush=True)
        return jsonify({"error": str(e)}), 500
...
if DATABASE_URL:
    try:
        ...
        print("ERROR initialising database:", e, flush=True)
